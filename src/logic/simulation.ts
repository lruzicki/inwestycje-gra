...
export const ASSET_DEFINITIONS: Record<AssetId, AssetDefinition> = {
  ...
  AKCJE_CDR: { id: 'AKCJE_CDR', label: 'CD Projekt', category: 'Akcje PL', annualReturn: 0.12, annualVolatility: 0.45 },
  AKCJE_KGH: { id: 'AKCJE_KGH', label: 'KGHM', category: 'Akcje PL', annualReturn: 0.09, annualVolatility: 0.35 },
  AKCJE_ALE: { id: 'AKCJE_ALE', label: 'Allegro', category: 'Akcje PL', annualReturn: 0.07, annualVolatility: 0.40 },
  ...
  AKCJE_MSFT: { id: 'AKCJE_MSFT', label: 'Microsoft', category: 'Świat', annualReturn: 0.18, annualVolatility: 0.20 },
  AKCJE_GOOG: { id: 'AKCJE_GOOG', label: 'Google', category: 'Świat', annualReturn: 0.16, annualVolatility: 0.22 },
  AKCJE_AMZN: { id: 'AKCJE_AMZN', label: 'Amazon', category: 'Świat', annualReturn: 0.17, annualVolatility: 0.25 },
  AKCJE_TSMC: { id: 'AKCJE_TSMC', label: 'TSMC (Chipy)', category: 'Świat', annualReturn: 0.20, annualVolatility: 0.30 },
  ETF_EM: { id: 'ETF_EM', label: 'ETF Emerging Markets', category: 'Świat', annualReturn: 0.09, annualVolatility: 0.22 },
  ETF_SP500: { id: 'ETF_SP500', label: 'ETF S&P 500', category: 'Świat', annualReturn: 0.115, annualVolatility: 0.15 },
